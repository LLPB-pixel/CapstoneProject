...
from prompt_guard.layers.layer1_heuristic.filter import (
    HeuristicFilter,
    HeuristicResult,
    TFIDFBaseline,
    PerplexityScorer,
...
class TestPerplexityPhase:
    ...
    def test_perplexity_none_when_scorer_unavailable(self):
        ...
        with patch('prompt_guard.layers.layer1_heuristic.filter.PerplexityScorer', side_effect=ImportError("no torch")):
            f = HeuristicFilter()
