...
_MODEL_DIR = os.path.join(_PROJECT_ROOT, "data", "models", "distilbert")
_MODEL_EXISTS = os.path.isdir(_MODEL_DIR)

# Saltar todos los tests si no hay modelo
pytestmark = pytest.mark.skipif(not _MODEL_EXISTS, reason=f"Modelo DistilBERT no encontrado en {_MODEL_DIR}")
