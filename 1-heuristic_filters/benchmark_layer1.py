...
Evalua:
  ...
  4. Rendimiento por componente (regex, tfidf, perplexity)

Uso:
  python benchmark_layer1.py [--samples N] [--data PATH]
"""
...
def main():
    ...
    parser.add_argument("--samples", type=int, default=2000, help="Numero total de muestras (default: 2000)")
    ...
    data_path = args.data or os.path.join(project_dir, "Data", "train.csv")
    ...
    configs = [
        ("Regex only", HeuristicFilter(use_perplexity=False, use_tfidf=False)),
        ("Regex + TF-IDF", HeuristicFilter(use_perplexity=False, use_tfidf=True)),
        ("Regex + TF-IDF + Perplexity", HeuristicFilter(use_perplexity=True, use_tfidf=True)),
    ]
